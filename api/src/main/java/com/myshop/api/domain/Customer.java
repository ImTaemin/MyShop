...
public class Customer implements UserDetails {
    ...
    public Customer(Long id, String userId, String password, String phone, String name, LocalDateTime createDate, List<String> roles, List<Orders> orderList, List<Cart> cartList, List<Wish> wishList, List<Coupon> usedCouponList) {
        this.id = id;
        this.userId = userId;
        this.password = password;
        this.phone = phone;
